...
#define DISABLE_INACTIVE_Z // Disable iif the nozzle could fall onto your printed part!
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 50*60, 50*60, 4*60, 2*60, 2*60, 2*60, 2*60, 2*60 } // (mm/min) Feedrates for manual moves along X, Y, Z, E from panel
