...
//
  ...
  #define U_STOP_PIN                       PI7   // M5 M4_STOP
  #define K_STOP_PIN                       PF6   // M5 M3_STOP
#endif
...
#define E2_ENABLE_PIN                       PD2
  ...
  #ifndef J_CS_PIN
    #define J_CS_PIN                       PE15
  #endif

  #define K_STEP_PIN                       PE12
  #define K_DIR_PIN                        PE10
  #define K_ENABLE_PIN                     PF14
  #ifndef K_CS_PIN
    #define K_CS_PIN                       PE7
  #endif

  #define U_STEP_PIN                       PG0
  #define U_DIR_PIN                        PG1
  #define U_ENABLE_PIN                     PE8
  #ifndef U_CS_PIN
    #define U_CS_PIN                       PF15
  #endif
...
//
  ...
  #if IS_U8GLIB_ST7920
    #define BOARD_ST7920_DELAY_1              96 // default: 125
    #define BOARD_ST7920_DELAY_2              48 // default: 90
