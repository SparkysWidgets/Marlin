...
#define HOMING_BUMP_MM      { 5, 5, 2, 45 }    // (linear=mm, rotational=°) Backoff from endstops after first bump
#define HOMING_BUMP_DIVISOR { 2, 2, 4, 4 }    // Re-Bump Speed Divisor (Divides the Homing Feedrate)       // Re-Bump Speed Divisor (Divides the Homing Feedrate)
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 50*60, 50*60, 4*60, 50*60, 25*60 } // (mm/min) Feedrates for manual moves along X, Y, Z, E from panel
