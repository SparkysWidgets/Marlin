...
#define HOMING_BUMP_DIVISOR { 2, 2, 2, 2, 2 }    // Re-Bump Speed Divisor (Divides the Homing Feedrate)       // Re-Bump Speed Divisor (Divides the Homing Feedrate)
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 50*60, 50*60, 4*60, 4*60, 4*60 } // (mm/min) Feedrates for manual moves along X, Y, Z, E from panel
