...
#if STATUS_LOGO_WIDTH && ENABLED(CUSTOM_STATUS_SCREEN_IMAGE) && NONE(LCD_SHOW_SECONDARY_AXES, LCD_SHOW_SECONDARY_AXES)
  #define DO_DRAW_LOGO 1
#endif
#if HOTENDS > 0 && DISABLED(LCD_SHOW_SECONDARY_AXES) && !HAS_K_AXIS
